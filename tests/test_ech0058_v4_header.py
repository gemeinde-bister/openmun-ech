"""Tests for eCH-0058 v4 Message Header Pydantic models.

Version: v4.0 (WITHOUT namedMetaData field)
"""
...
from openmun_ech.ech0058.v4 import (
    AnyXMLContent,
    ActionType,
...
class TestECH0058SendingApplication:
    ...
    def test_to_xml(self):
        ...
        assert elem.tag == '{http://www.ech.ch/xmlns/eCH-0058/4}sendingApplication'
        assert elem.find('{http://www.ech.ch/xmlns/eCH-0058/4}manufacturer').text == "OpenMun"
        assert elem.find('{http://www.ech.ch/xmlns/eCH-0058/4}product').text == "Municipality System"
        assert elem.find('{http://www.ech.ch/xmlns/eCH-0058/4}productVersion').text == "1.0.0"
...
class TestECH0058PartialDelivery:
    ...
    def test_to_xml(self):
        ...
        # Check element structure
        assert elem.tag == '{http://www.ech.ch/xmlns/eCH-0058/4}partialDelivery'
        assert elem.find('{http://www.ech.ch/xmlns/eCH-0058/4}uniqueIdDelivery').text == "delivery-123"
        assert elem.find('{http://www.ech.ch/xmlns/eCH-0058/4}totalNumberOfPackages').text == "5"
        assert elem.find('{http://www.ech.ch/xmlns/eCH-0058/4}numberOfActualPackage').text == "2"
...
class TestECH0058Header:
    ...
    def test_to_xml_minimal(self):
        ...
        # Check element structure
        ns = '{http://www.ech.ch/xmlns/eCH-0058/4}'
